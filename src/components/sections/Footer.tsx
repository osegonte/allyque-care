          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a 
                ...
                className="w-10 h-10 bg-[#1877F2] hover:bg-[#1877F2]/90 rounded-lg flex items-center justify-center transition-all shadow-sm hover:shadow-md"
                aria-label="Facebook"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg flex items-center justify-center transition-all shadow-sm hover:shadow-md"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-black hover:bg-black/90 rounded-lg flex items-center justify-center transition-all shadow-sm hover:shadow-md"
